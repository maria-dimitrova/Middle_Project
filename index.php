...
<title>Welcome to Super Shop</title>
...
<div id="big">
	<div id="container">
		...
		<div id="enter">Регистригахте се успешно! Моля влезте във Вашия акаунт.</div>
		
		<div id="listing">
			<div class="wraper-listing">
			<h1>БЕЗПЛАТНИ ОБЯВИ ОТ ЦЯЛАТА СТРАНА</h1>
				<ul>
					<li><img id="check" src="assets/images/img.png"><span>Инфо</span><span>Цена</span></li>
